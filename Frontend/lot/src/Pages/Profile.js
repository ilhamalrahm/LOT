...
const Profile = () => {
    ...
    return (
        <div style={{ margin: 0, padding: 0,backgroundColor: '#181818',height:"100vh" }}>
            <div className="container-fluid" style={{ backgroundColor: '#181818', display: 'grid', height: 750, gridTemplateColumns: '7.5% 67.5% 25%', gridTemplateRows: '7.84% 92.16%' }}>
                ...
                <div className='details' style={{ backgroundColor: 'black', fontFamily: "Plus Jakarta Sans",height:"100vh"  }}>
                    ...
                    <div className="details text-white" style={{ color: '#FFB703', textAlign: 'left' }}>
                        <form action="noaction.php">
                            <div className="formgroup1" style={{ paddingLeft: '20%', paddingRight: '20%', paddingTop: '10%' }}>
                                ...
                                <input type="text" disabled="true" value={context.name} name="" style={{ width: '100%', background: 'linear-gradient(94.47deg, rgba(0, 0, 0, 0) 3.97%, rgba(0, 0, 0, 0.12) 58.88%, #000000 100.7%)', borderRadius: '5px', border: '1px solid #FFFFFF', padding: '2%',color:"white"  }}></input>
                            </div>
                            <div className="formgroup2 text-white" style={{ paddingLeft: '20%', paddingRight: '20%', paddingTop: '10%' }}>
                                Email ID <br></br>
                                <input type="email"  disabled="true" value={context.email} name="" style={{ width: '100%', background: 'linear-gradient(94.47deg, rgba(0, 0, 0, 0) 3.97%, rgba(0, 0, 0, 0.12) 58.88%, #000000 100.7%)', borderRadius: '5px', border: '1px solid #FFFFFF', padding: '2%',color:"white" }}></input>
                            </div>
                            <div className="formgroup3" style={{ paddingLeft: '20%', paddingRight: '20%', paddingTop: '10%' }}>
                                College <br></br>
                                <input type="email" disabled="true" name="" style={{ width: '100%', background: 'linear-gradient(94.47deg, rgba(0, 0, 0, 0) 3.97%, rgba(0, 0, 0, 0.12) 58.88%, #000000 100.7%)', borderRadius: '5px', border: '1px solid #FFFFFF', padding: '2%',color:"white" }}></input>
                            </div>
                            <div className="formgroup4" style={{ paddingLeft: '20%', paddingRight: '20%', paddingTop: '10%' }}>
                                Committee <br></br>
                                <input type="text" disabled="true" name="" style={{ width: '100%', background: 'linear-gradient(94.47deg, rgba(0, 0, 0, 0) 3.97%, rgba(0, 0, 0, 0.12) 58.88%, #000000 100.7%)', borderRadius: '5px', border: '1px solid #FFFFFF', padding: '2%',color:"white" }}></input>
                            </div>
