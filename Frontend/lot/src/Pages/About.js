...
const About=()=>{
    ...
    return(
        ...
        <div className="main" style={{backgroundColor:"black",height:"100vh",overflow:"hidden",position:"relative"}}>
            <div className="container-fluid" style={{ backgroundColor: '#181818', display: 'grid', height: 750, gridTemplateColumns: '50% 10% 40%', gridTemplateRows: '7.84% 92.16%' }}>
            ...
            <img src={map} align="right" height="10%" width="110%" style={{paddingRight:"15%"}}></img>
